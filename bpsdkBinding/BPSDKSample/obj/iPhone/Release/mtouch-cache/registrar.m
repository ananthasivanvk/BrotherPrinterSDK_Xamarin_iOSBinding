...
@implementation UIApplicationDelegate {
	...
	-(id) init
	{
		...
		id rv = native_to_managed_trampoline_1 (self, _cmd, &managed_method, &call_super, 0x22104);
		if (call_super && rv) {
...
@implementation UIKit_UIControlEventProxy {
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_2 (self, _cmd, &managed_method, 0x1D204);
	}

	-(BOOL) conformsToProtocol:(void *)p0
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_3 (self, _cmd, &managed_method, p0, 0x2B404);
	}
@end
...
@implementation __MonoMac_NSActionDispatcher {
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_2 (self, _cmd, &managed_method, 0x29704);
	}
...
@implementation __MonoMac_NSAsyncActionDispatcher {
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_2 (self, _cmd, &managed_method, 0x29A04);
	}
...
@implementation __NSObject_Disposer {
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_10 (self, _cmd, &managed_method, p0, 0x2DB04);
	}
	...
	-(id) init
	{
		static MonoMethod *managed_method = NULL;
		bool call_super = false;
		id rv = native_to_managed_trampoline_1 (self, _cmd, &managed_method, &call_super, 0x2D904);
		if (call_super && rv) {
			struct objc_super super = {  rv, [NSObject class] };
			rv = ((id (*)(objc_super*, SEL)) objc_msgSendSuper) (&super, @selector (init));
		}
...
@implementation BRPtouchNetworkDelegate {
	...
	-(id) init
	{
		static MonoMethod *managed_method = NULL;
		bool call_super = false;
		id rv = native_to_managed_trampoline_1 (self, _cmd, &managed_method, &call_super, 0x8308);
		if (call_super && rv) {
			struct objc_super super = {  rv, [NSObject class] };
			rv = ((id (*)(objc_super*, SEL)) objc_msgSendSuper) (&super, @selector (init));
		}
...
#pragma clang diagnostic pop
	...
	static MTClassMap __xamarin_class_map [] = {
		{ NULL, 0x7E04 /* #0 'NSObject' => 'Foundation.NSObject, Xamarin.iOS' */ },
		{ NULL, 0x6404 /* #1 'UIApplicationDelegate' => 'UIKit.UIApplicationDelegate, Xamarin.iOS' */ },
		{ NULL, 0x6A04 /* #2 'UIResponder' => 'UIKit.UIResponder, Xamarin.iOS' */ },
		{ NULL, 0x5E04 /* #3 'UIViewController' => 'UIKit.UIViewController, Xamarin.iOS' */ },
		...
		{ NULL, 0x5204 /* #6 'UIApplication' => 'UIKit.UIApplication, Xamarin.iOS' */ },
		{ NULL, 0x5D04 /* #7 'UIView' => 'UIKit.UIView, Xamarin.iOS' */ },
		{ NULL, 0x5504 /* #8 'UIControl' => 'UIKit.UIControl, Xamarin.iOS' */ },
		{ NULL, 0x5304 /* #9 'UIButton' => 'UIKit.UIButton, Xamarin.iOS' */ },
		{ NULL, 0x5404 /* #10 'UIKit_UIControlEventProxy' => 'UIKit.UIControlEventProxy, Xamarin.iOS' */ },
		{ NULL, 0x5604 /* #11 'UIDevice' => 'UIKit.UIDevice, Xamarin.iOS' */ },
		{ NULL, 0x5804 /* #12 'UIImage' => 'UIKit.UIImage, Xamarin.iOS' */ },
		{ NULL, 0x5C04 /* #13 'UIScreen' => 'UIKit.UIScreen, Xamarin.iOS' */ },
		{ NULL, 0x5F04 /* #14 'UIWindow' => 'UIKit.UIWindow, Xamarin.iOS' */ },
		{ NULL, 0x6004 /* #15 'UIAlertAction' => 'UIKit.UIAlertAction, Xamarin.iOS' */ },
		{ NULL, 0x6204 /* #16 'UIAlertController' => 'UIKit.UIAlertController, Xamarin.iOS' */ },
		{ NULL, 0x6C04 /* #17 'NSArray' => 'Foundation.NSArray, Xamarin.iOS' */ },
		{ NULL, 0x7104 /* #18 'NSMutableArray' => 'Foundation.NSMutableArray, Xamarin.iOS' */ },
		{ NULL, 0x7204 /* #19 'NSPredicate' => 'Foundation.NSPredicate, Xamarin.iOS' */ },
		{ NULL, 0x7304 /* #20 'NSRunLoop' => 'Foundation.NSRunLoop, Xamarin.iOS' */ },
		{ NULL, 0x7404 /* #21 'NSString' => 'Foundation.NSString, Xamarin.iOS' */ },
		{ NULL, 0x7A04 /* #22 '__MonoMac_NSActionDispatcher' => 'Foundation.NSActionDispatcher, Xamarin.iOS' */ },
		{ NULL, 0x7B04 /* #23 '__MonoMac_NSAsyncActionDispatcher' => 'Foundation.NSAsyncActionDispatcher, Xamarin.iOS' */ },
		{ NULL, 0x7C04 /* #24 'NSAutoreleasePool' => 'Foundation.NSAutoreleasePool, Xamarin.iOS' */ },
		{ NULL, 0x8504 /* #25 'NSException' => 'Foundation.NSException, Xamarin.iOS' */ },
		{ NULL, 0x8604 /* #26 'NSNull' => 'Foundation.NSNull, Xamarin.iOS' */ },
		{ NULL, 0x6D04 /* #27 'NSData' => 'Foundation.NSData, Xamarin.iOS' */ },
		{ NULL, 0x6F04 /* #28 'NSDictionary' => 'Foundation.NSDictionary, Xamarin.iOS' */ },
		...
		{ NULL, 0x8004 /* #31 '__NSObject_Disposer' => 'Foundation.NSObject+NSObject_Disposer, Xamarin.iOS' */ },
		{ NULL, 0xC08 /* #32 'BRPtouchBLEManager' => 'bpsdkBinding.BRPtouchBLEManager, bpsdkBinding' */ },
		{ NULL, 0xD08 /* #33 'BRPtouchBluetoothManager' => 'bpsdkBinding.BRPtouchBluetoothManager, bpsdkBinding' */ },
		{ NULL, 0xE08 /* #34 'BRPtouchDeviceInfo' => 'bpsdkBinding.BRPtouchDeviceInfo, bpsdkBinding' */ },
		{ NULL, 0xF08 /* #35 'BRPtouchLabelInfoStatus' => 'bpsdkBinding.BRPtouchLabelInfoStatus, bpsdkBinding' */ },
		{ NULL, 0x1008 /* #36 'BRPtouchLabelParam' => 'bpsdkBinding.BRPtouchLabelParam, bpsdkBinding' */ },
		{ NULL, 0x1108 /* #37 'BRPtouchNetworkDelegate' => 'bpsdkBinding.BRPtouchNetworkDelegate, bpsdkBinding' */ },
		{ NULL, 0x1208 /* #38 'BRPtouchNetworkManager' => 'bpsdkBinding.BRPtouchNetworkManager, bpsdkBinding' */ },
		{ NULL, 0x1308 /* #39 'BRPtouchPrinter' => 'bpsdkBinding.BRPtouchPrinter, bpsdkBinding' */ },
		{ NULL, 0x1408 /* #40 'BRPtouchPrinterData' => 'bpsdkBinding.BRPtouchPrinterData, bpsdkBinding' */ },
		{ NULL, 0x1508 /* #41 'BRPtouchPrinterKit' => 'bpsdkBinding.BRPtouchPrinterKit, bpsdkBinding' */ },
		{ NULL, 0x1608 /* #42 'BRPtouchPrinterStatus' => 'bpsdkBinding.BRPtouchPrinterStatus, bpsdkBinding' */ },
		{ NULL, 0x1708 /* #43 'BRPtouchPrintInfo' => 'bpsdkBinding.BRPtouchPrintInfo, bpsdkBinding' */ },
		{ NULL, 0 },
	};
	...
	static const MTProtocolWrapperMap __xamarin_protocol_wrapper_map [] = {
		...
		{ 0x6804 /* UIKit.IUIDynamicItem */, 0x6904 /* UIDynamicItemWrapper */ },
		{ 0x8704 /* Foundation.INSObjectProtocol */, 0x8804 /* NSObjectProtocolWrapper */ },
	};
